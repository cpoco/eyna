...
const main = async () => {
	...
	assert.strictEqual(arc.list[0].ctime, 0)
	assert.strictEqual(arc.list[0].cnsec, 0)
	...
	assert.strictEqual(arc.list[1].ctime, 0)
	assert.strictEqual(arc.list[1].cnsec, 0)
	assert.strictEqual(arc.list[1].mtime, 0)
	...
	assert.strictEqual(arc.list[2].ctime, 0)
	assert.strictEqual(arc.list[2].cnsec, 0)
	assert.strictEqual(arc.list[2].mtime, 0)
	...
	assert.strictEqual(arc.list[3].ctime, 0)
	assert.strictEqual(arc.list[3].cnsec, 0)
	assert.strictEqual(arc.list[3].mtime, 0)
	...
	assert.strictEqual(arc.list[4].ctime, 0)
	assert.strictEqual(arc.list[4].cnsec, 0)
	...
	assert.strictEqual(arc.list[5].ctime, 0)
	assert.strictEqual(arc.list[5].cnsec, 0)
	...
	assert.strictEqual(arc.list[6].ctime, 0)
	assert.strictEqual(arc.list[6].cnsec, 0)
	...
	assert.strictEqual(arc.list[7].ctime, 0)
	assert.strictEqual(arc.list[7].cnsec, 0)
	...
	assert.strictEqual(arc.list[8].ctime, 0)
	assert.strictEqual(arc.list[8].cnsec, 0)
...
try {
	main().then(() => {
		console.log("")
		console.log("done (test_arc_tarzst)")
	})
}
catch (err) {
	console.error(err)
