...
await fs.symlink(path.join(wd, "LINK"), path.join(wd, "LINK", "la_self_0"))
await fs.symlink(path.join(wd, "LINK") + "/", path.join(wd, "LINK", "la_self_1"))
await fs.symlink(path.join(wd, "LINK") + "/.", path.join(wd, "LINK", "la_self_2"))
...
await fs.symlink(path.join(wd, "LINK") + "/..", path.join(wd, "LINK", "la_parent_0"))
await fs.symlink(path.join(wd, "LINK") + "/../", path.join(wd, "LINK", "la_parent_1"))
await fs.symlink(path.join(wd, "LINK") + "/../.", path.join(wd, "LINK", "la_parent_2"))
...
await fs.symlink(path.join(wd, "LINK") + "/error", path.join(wd, "LINK", "la_error_0"))
await fs.symlink(path.join(wd, "LINK") + "/error/", path.join(wd, "LINK", "la_error_1"))
await fs.symlink(path.join(wd, "LINK") + "/error/.", path.join(wd, "LINK", "la_error_2"))
